...
pub fn generic_strassen(a: &Matrix<i32>, b: &Matrix<i32>, mul: &dyn Fn(&Matrix<i32>, &Matrix<i32>) -> Matrix<i32>) -> Matrix<i32> {
    let (a11, a12, a21, a22);
    let (b11, b12, b21, b22);
...
mod tests {
    use crate::matrix::matrix::Matrix;
    use crate::matrix::generic_strassen::{
        connect_4_matrices,
        explode_matrix_to_4
    };
